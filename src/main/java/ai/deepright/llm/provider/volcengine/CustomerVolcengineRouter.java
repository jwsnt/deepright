...
import ai.open.right.workflow.flow.llm.provider.volcengine.VolcengineRouter;
...
@Getter
@Setter
public class CustomerVolcengineRouter extends VolcengineRouter {
    ...
    public static class CustomerInitConfig extends InitConfig {
        ...
        @Override
        @Bean(VolcengineRouter.NAME)
        @ConditionalOnMissingBean(name = VolcengineRouter.NAME)
        public VolcengineRouter volcengineRouter() {
            CustomerVolcengineRouter volcengineRouter = new CustomerVolcengineRouter();
            BeanUtils.copyProperties(this, volcengineRouter);
            log.info("CustomerVolcengineModelRouter inited");
