...
import ai.open.right.workflow.flow.llm.provider.kimi.KimiRouter;
...
@Getter
@Setter
public class CustomerKimiRouter extends KimiRouter {
    ...
    public static class CustomerInitConfig extends InitConfig {
        ...
        public KimiRouter kimiRouter() {
            ...
            log.info("CustomerKimiModelRouter inited");
            return kimiRouter;
        }
    }
}
