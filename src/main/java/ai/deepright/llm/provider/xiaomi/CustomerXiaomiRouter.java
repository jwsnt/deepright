...
import ai.open.right.workflow.flow.llm.provider.xiaomi.XiaomiRouter;
...
@Getter
@Setter
public class CustomerXiaomiRouter extends XiaomiRouter {
    ...
    public static class CustomerInitConfig extends InitConfig {
        ...
        @Override
        @Bean(XiaomiRouter.NAME)
        @ConditionalOnMissingBean(name = XiaomiRouter.NAME)
        public XiaomiRouter xiaomiRouter() {
            CustomerXiaomiRouter xiaomiRouter = new CustomerXiaomiRouter();
            BeanUtils.copyProperties(this, xiaomiRouter);
            log.info("CustomerXiaomiRouter inited");
            return xiaomiRouter;
        }
    }
}
