...
import ai.open.right.workflow.flow.llm.provider.google.GeminiQueryService;
...
@Slf4j
public class CustomerGeminiQueryService extends GeminiQueryService {
    ...
    public static class CustomerInitConfig extends InitConfig {
        ...
        public CustomerGeminiQueryService geminiQueryService() throws Exception {
            CustomerGeminiQueryService geminiQueryService = new CustomerGeminiQueryService();
            BeanUtils.copyProperties(this, geminiQueryService);
            log.info("CustomerGeminiQueryService inited");
