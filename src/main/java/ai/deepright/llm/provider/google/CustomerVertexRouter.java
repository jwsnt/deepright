...
import ai.open.right.workflow.flow.llm.provider.google.VertexRouter;
...
@Getter
@Setter
public class CustomerVertexRouter extends VertexRouter {
    ...
    public static class CustomerInitConfig extends InitConfig {
        ...
        public VertexRouter vertexRouter() {
            ...
            log.info("CustomerVertexRouter inited. urlStream={},urlOnce={},location={},projectId={}", vertexRouter.getUrlStream(), vertexRouter.getUrlOnce(), vertexRouter.getLocation(), vertexRouter.getProjectId());
            return vertexRouter;
        }
    }
}
