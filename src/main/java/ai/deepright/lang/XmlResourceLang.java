...
public final class XmlResourceLang {
    ...
    public static String get(String baseName, String key, Locale locale, ClassLoader loader) {
        try {
            WorkflowException.checkCondition(StringUtils.isEmpty(baseName), "The baseName could not find resource: " + baseName);
            WorkflowException.checkCondition(locale == null, "The locale could not find resource: " + locale);
            WorkflowException.checkCondition(loader == null, "The loader could not find resource: " + loader);
            WorkflowException.checkCondition(StringUtils.isEmpty(key), "The key could not find resource: " + key);
