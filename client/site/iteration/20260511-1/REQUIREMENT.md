...
### 需求介绍
+ 右侧边栏最下（知识库内容展示）使用/knowledge接口加载数据
    + Integration（唯一入口）需求：../../../integration/iteration/20260511-1/REQUIREMENT.md
    + Proxy需求：../../../proxy/iteration/20260511-1/REQUIREMENT.md
    + 知识库需求：../../iteration/20260510-1/REQUIREMENT.md
+ 知识库内容（包括树形结构时）需要完全展开，使用整栏空间，超过展示区域则使用滚动条
+ 知识库WIKI标题下，知识库内容上的导航路径需要可以点击刷新：
    + 可回退的路径段能点，当前叶子节点不能点
    ``` 案例，如展示如下时
    /knowledge/l2/entity-artifacts.md
    ```
    + 点击/knowledge/l2部分，加载刷新/knowledge/l2
    + 点击/knowledge部分，加载刷新/knowledge
+ 刷新小图标功能改为重新加载知识库，回到首页
