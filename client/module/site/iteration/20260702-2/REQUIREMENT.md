...
### 需求介绍
+ 首次点击虚拟文件系统Knowledge.md或knowledge.md的任意位置，如查看或编辑文件等（无任何点击Knowledge.md或knowledge.md任意位置记录）时开启引导对话输入的新手引导任务
    + 在Knowledge.md或knowledge.md整个文件增加新手引导的遮罩，高亮选择框，并暗淡其他部分并不可点击
        + 新手引导文案：编辑Knowledge.md调整知识库提取规则。
