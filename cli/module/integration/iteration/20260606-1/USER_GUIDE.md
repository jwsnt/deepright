...
- 如果没有显式传 `connect-bin`，integration 会自动补齐当前 integration 主二进制路径
...
- `integration/main.go` 已新增 `/api/plugins/exec` 路由与 `plugins exec` CLI
- `integration/USER_GUIDE.md` 已同步补充接口与 CLI 说明
