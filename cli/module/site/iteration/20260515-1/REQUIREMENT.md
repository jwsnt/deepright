...
+ 由skill小图标触发的SSE请求，本轮请求结束后不再调用状态刷新来判断是否需要点亮Skill图标, 无论这轮里是否又产生cli/get或cli/pub，图标都会保持熄灭，普通请求的原有判断逻辑不变。
+ 由skill小图标触发的SSE请求都会附带metadata {"extract": true}
    + Skill小图标需求：../20260514-1/REQUIREMENT.md
