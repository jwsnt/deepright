...
### 需求介绍
+ 为虚拟文件系统中SOUL.md这个文件添加小灯泡图标，点击后展示浮层，提示用户是否需要整理SOUL.md
    + 提示文案：检测到SOUL.md，是否重新整理？
    + 小灯泡图标在最右侧，保证展示删除和下载图标时不出现位置跳动
+ 浮层风格同：../20260515-3/REQUIREMENT.md
``` 提示内容
按@SOUL.md的要求重新整理 [FILE:/.../SOUL.mdd]
```
    + 其中[FILE:/.../SOUL.mdd]是文件系统绝对路径，需要用小气泡表示
    + 点击确认后自动在当前Agent+Chat（当前对话框）发送提示内容
+ SOUL.md的小灯泡图标默认为灰色，仅当最后更新时间距离当前时间超过8小时进行闪动
    + 判断时间需求：
