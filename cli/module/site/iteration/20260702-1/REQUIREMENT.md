...
### 需求介绍
+ 如果设置中，Agent列表存在Agent，则在下拉列表小三角前增加一个复制小图标
+ 点开复制小图标，交互等同于创建Agent，但是创建改为复制，点击复制后同样创建Agent，并在成功后调用接口/api/copy复制目录，复制时需要锁定界面，成功或失败后解锁
+ Integration需求：../../../integration/iteration/20260702-1/REQUIREMENT.md
