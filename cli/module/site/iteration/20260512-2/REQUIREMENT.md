...
### 需求介绍
+ 左侧Sidebar新会话下方，紧贴最近的右侧，新增显著高亮小灯泡图标（与标题最近左对齐）
+ 读取http://127.0.0.1:8080/install_app，如果不是空数组（[]）则闪烁小灯泡，如果空则不展示小灯泡图标
    + Integration需求：../../../integration/iteration/20260512-1/REQUIREMENT.md
