...
func responseSchemaJSONLocal() string {
	return strings.TrimSpace(localResponseSchemaRaw)
}

func responseSchemaDefinitionLocal() map[string]any {
	var schema map[string]any
	_ = json.Unmarshal([]byte(responseSchemaJSONLocal()), &schema)
	return schema
}
