...
@Getter
@Slf4j
public class QwenQueryService extends OpenAiQueryService {

    protected QwenRequestService qwenRequestService;

    protected QwenRouter qwenRouter;
    ...
    protected ProviderRequestService<OpenAiRequest> request() {
        return this.qwenRequestService;
    }

    @Override
    protected ProviderRouter<OpenAiRequest> router() {
        return this.qwenRouter;
    }
    ...
    public static class InitConfig extends ProviderQueryInitConfig {
        ...
        public QwenQueryService qwenQueryService() throws Exception {
            QwenQueryService qwenQueryService = new QwenQueryService();
            BeanUtils.copyProperties(this, qwenQueryService);
            log.info("QwenQueryService inited");
