...
@Getter
@Slf4j
public class DeepSeekQueryService extends OpenAiQueryService {

    protected DeepSeekRequestService deepSeekRequestService;

    protected DeepSeekRouter deepSeekRouter;
    ...
    protected ProviderRequestService<OpenAiRequest> request() {
        return this.deepSeekRequestService;
    }

    @Override
    protected ProviderRouter<OpenAiRequest> router() {
        return this.deepSeekRouter;
    }
    ...
    public static class InitConfig extends ProviderQueryInitConfig {
        ...
        public DeepSeekQueryService deepSeekQueryService() throws Exception {
            DeepSeekQueryService deepSeekQueryService = new DeepSeekQueryService();
            BeanUtils.copyProperties(this, deepSeekQueryService);
            log.info("DeepSeekQueryService inited");
