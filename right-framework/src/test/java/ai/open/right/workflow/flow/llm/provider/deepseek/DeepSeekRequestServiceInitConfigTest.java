...
public class DeepSeekRequestServiceInitConfigTest {
    ...
    public void testInit() throws Exception {
        ...
        DeepSeekRequestService.InitConfig initConfig = new DeepSeekRequestService.InitConfig();
        ...
        DeepSeekRequestService requestService = initConfig.deepSeekRequestService();
    ...
    public void testHashCode1() throws Exception {
        Object object = DeepSeekRequestService.class.getConstructor(null).newInstance(null);
    ...
    public void testHashCode2() throws Exception {
        Object object = DeepSeekRequestService.InitConfig.class.getConstructor(null).newInstance(null);
        Assert.assertEquals(object.hashCode(), object.hashCode());
        Assert.assertEquals(object, object);
    }
}
