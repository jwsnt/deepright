...
public class DeepSeekRouterInitConfigTest {
    ...
    public void testInit() throws Exception {
        ...
        DeepSeekRouter.InitConfig initConfig = new DeepSeekRouter.InitConfig();
        ...
        DeepSeekRouter router = initConfig.deepSeekRouter();
