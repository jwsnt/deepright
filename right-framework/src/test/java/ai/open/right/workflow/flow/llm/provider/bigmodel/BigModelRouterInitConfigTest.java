...
public class BigModelRouterInitConfigTest {
    ...
    public void testInit() throws Exception {
        ...
        BigModelRouter.InitConfig initConfig = new BigModelRouter.InitConfig();
        ...
        BigModelRouter router = initConfig.bigModelRouter();
