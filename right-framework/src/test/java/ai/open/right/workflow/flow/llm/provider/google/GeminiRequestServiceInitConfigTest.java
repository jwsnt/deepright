...
public class GeminiRequestServiceInitConfigTest {
    ...
    public void testInit() throws Exception {
        ...
        initConfig.setPolicy("POLICY");
        GeminiRequestService requestService = initConfig.geminiRequestService();
        Assert.assertEquals(requestService.getPolicy(), initConfig.getPolicy());
