...
public class BigModelRouterTest {
    ...
    public void testInit() throws Exception {
        ...
        BigModelRouter router = new BigModelRouter();
    ...
    public void testHashCode1() throws Exception {
        Object object = BigModelRouter.class.getConstructor(null).newInstance(null);
    ...
    public void testHashCode2() throws Exception {
        Object object = BigModelRouter.InitConfig.class.getConstructor(null).newInstance(null);
        Assert.assertEquals(object.hashCode(), object.hashCode());
        Assert.assertEquals(object, object);
    }
}
