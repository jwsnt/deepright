...
public class KimiRouterTest {

    @Test
    public void testHashCode1() throws Exception {
        Object object = KimiRouter.class.getConstructor(null).newInstance(null);
    ...
    public void testHashCode2() throws Exception {
        Object object = KimiRouter.InitConfig.class.getConstructor(null).newInstance(null);
        Assert.assertEquals(object.hashCode(), object.hashCode());
        Assert.assertEquals(object, object);
    }
    ...
    public void testInit() throws Exception {
        ...
        KimiRouter router = new KimiRouter();
