...
public class VolcengineRouterInitConfigTest {
    ...
    public void testInit() throws Exception {
        ...
        VolcengineRouter.InitConfig initConfig = new VolcengineRouter.InitConfig();
        ...
        VolcengineRouter router = initConfig.volcengineRouter();
