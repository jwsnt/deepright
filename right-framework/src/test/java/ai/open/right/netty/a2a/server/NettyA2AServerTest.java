...
public class NettyA2AServerTest {
    ...
    public void test() {
        ...
        NettyA2AServer server = new NettyA2AServer();
        ...
        server.setIdle(1024);
        Assert.assertEquals(server.new A2AInitializer(100, 100).getChannelHandler().length, 5);
        EasyMock.verify(channel, pipeline);
    }

    @Test
    public void testInit() throws Exception {
        NettyA2AHandler mcpHandler = EasyMock.createMock(NettyA2AHandler.class);
        NettyA2AServer.InitConfig initConfig = new NettyA2AServer.InitConfig();
        initConfig.setA2aHandler(mcpHandler);
        ...
        NettyA2AServer nettyMcpServer = initConfig.nettyA2AServer();
        Assert.assertEquals(mcpHandler, nettyMcpServer.getA2aHandler());
    ...
    public void testHashCode1() throws Exception {
        Object object = NettyA2AServer.class.getConstructor(null).newInstance(null);
    ...
    public void testHashCode2() throws Exception {
        Object object = NettyA2AServer.InitConfig.class.getConstructor(null).newInstance(null);
        Assert.assertEquals(object.hashCode(), object.hashCode());
        Assert.assertEquals(object, object);
    }
}
