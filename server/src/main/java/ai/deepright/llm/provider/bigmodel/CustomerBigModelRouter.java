...
import ai.open.right.workflow.flow.llm.provider.bigmodel.BigModelRouter;
...
@Getter
@Setter
public class CustomerBigModelRouter extends BigModelRouter {
    ...
    public static class CustomerInitConfig extends InitConfig {
        ...
        @Value("${request.provider.focus:0.5}")
        ...
        public BigModelRouter bigModelRouter() {
            ...
            log.info("CustomerBigModelRouter inited");
            return customerBigModelRouter;
        }
    }
}
