...
@Slf4j
public class CustomerAnthropicReader extends AnthropicReader {

    public CustomerAnthropicReader(ProviderReaderConfig<AnthropicRequest> providerReaderConfig) throws Exception {
        super(providerReaderConfig);
    }

    @Override
    protected ProviderReaderCallback buildReaderCallback(ProviderReaderConfig<AnthropicRequest> providerReaderConfig) throws Exception {
