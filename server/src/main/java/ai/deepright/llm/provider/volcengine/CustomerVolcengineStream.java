...
public class CustomerVolcengineStream extends CustomerOpenAiStreamFunCall {

    public CustomerVolcengineStream(ProviderStreamConfig<OpenAiRequest> providerRequestConfig) throws Exception {
