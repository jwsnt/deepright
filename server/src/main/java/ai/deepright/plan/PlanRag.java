...
public class PlanRag extends RagCondition implements RagService {
    ...
    public void init() throws Exception {
        ...
        WorkflowException.checkCondition(StringUtils.isEmpty(this.template4updateVerify), "The plan update verify template can not be empty");
        WorkflowException.checkCondition(StringUtils.isEmpty(this.template4appendVerify), "The plan append verify template can not be empty");
        WorkflowException.checkCondition(StringUtils.isEmpty(this.template4appendShort), "The plan append short template can not be empty");
        WorkflowException.checkCondition(StringUtils.isEmpty(this.template4create), "The plan create template can not be empty");
        WorkflowException.checkCondition(StringUtils.isEmpty(this.template4update), "The plan update template can not be empty");
    }
